...
- Import the API
    ...
    - Option 2: Using the git based API synchornization.
        ...
        https://apim.docs.wso2.com/en/4.5.0/install-and-setup/setup/api-controller/cicd-using-cli/#a-promoting-apis-in-a-git-repository-to-upper-environments-via-cicd
