- Start the API Manager using the below command
    ...
    - DEV environment
        ...
        `sh dev/wso2am-4.5.0/bin/api-manager.sh start`{{exec}}

        Check the logs and wait till server starts.

        `tail -f dev/wso2am-4.5.0/repository/logs/wso2carbon.log`{{exec}}

    - PROD environment

        `sh prod/wso2am-4.5.0/bin/api-manager.sh start`{{exec}}

        Check the logs and wait till server starts.

        `tail -f prod/wso2am-4.5.0/repository/logs/wso2carbon.log`{{exec}}
