- Copy the required resources to server
    - create a directory for images and copy the log file under the devportal
      ...
      `mkdir apim1/wso2am-4.5.0/repository/deployment/server/webapps/devportal/site/public/theme/images`{{exec}}

      `cp resources/images/logo.png apim1/wso2am-4.5.0/repository/deployment/server/webapps/devportal/site/public/theme/images/`{{exec}}

- Open the custom theme file and update relevent section

    `vi apim1/wso2am-4.5.0/repository/deployment/server/webapps/devportal/site/public/theme/userTheme.json`{{exec}}
