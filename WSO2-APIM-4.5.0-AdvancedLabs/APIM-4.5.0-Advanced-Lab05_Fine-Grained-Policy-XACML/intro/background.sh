...
cp /root/resources/client-truststore.jks apim1/wso2am-4.5.0/repository/resources/security/client-truststore.jks
cp /root/resources/log4j2.properties apim1/wso2am-4.5.0/repository/conf/log4j2.properties
...
#mysql -u root wso2am_db < apim1/wso2am-4.5.0/dbscripts/apimgt/mysql.sql
mysql -u root wso2shared_db < apim1/wso2am-4.5.0/dbscripts/mysql.sql
...
cp mysql-connector-java-8.0.27.jar /root/apim1/wso2am-4.5.0/repository/components/lib/
