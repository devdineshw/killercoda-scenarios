- Enable correlation logs
  - Option 1: Updayte the startup script
    - Open the startup script
      ...
      `vi apim1/wso2am-4.5.0/bin/api-manager.sh`{{exec}}
  ...
  - Option 2: Enable during the startup using a startup parameter
    ...
    `sh apim1/wso2am-4.5.0/bin/api-manager.sh -DenableCorrelationLogs=true start`
...
- Check the correlation logs
  ...
  `tail -f apim1/wso2am-4.5.0/repository/logs/correlation.log`{{exec}}

  More details about correlation logs available <a href="https://apim.docs.wso2.com/en/4.5.0/observe/api-manager/monitoring-correlation-logs/">here</a>
