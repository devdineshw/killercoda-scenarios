...
- Create the tables using the DB scripts comes with the WSO2 APIM. Use root as the password.
  ...
  `mysql -u root -p -v wso2am_db < apim1/wso2am-4.5.0/dbscripts/apimgt/mysql.sql`{{execute}}

  `mysql -u root -p -v wso2shared_db < apim1/wso2am-4.5.0/dbscripts/mysql.sql`{{execute}}

- Download the MySQL JDBC Driver

  `wget -O mysql-connector-java-8.0.27.jar https://repo1.maven.org/maven2/mysql/mysql-connector-java/8.0.27/mysql-connector-java-8.0.27.jar`{{execute}}