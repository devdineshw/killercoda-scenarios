...
- Import the KeyManager's public certificate to WSO2 API-M's client-truststore.jks
  ...
  - Import the public key to APIM trust store. Enter 'yes' to confirm
    ...
    `keytool -import -alias wso2carbonis -file is_km_public.pem -keystore apim1/wso2am-4.5.0/repository/resources/security/client-truststore.jks -storepass wso2carbon`{{execute}}
