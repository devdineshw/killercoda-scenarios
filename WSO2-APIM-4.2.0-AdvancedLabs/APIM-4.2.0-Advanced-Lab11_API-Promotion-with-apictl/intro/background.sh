...
mkdir /root/dev
unzip /root/wso2am-4.2.0.zip -d /root/dev/
cp /root/resources/original-deployment.toml /root/dev/wso2am-4.2.0/repository/conf/deployment.toml
cp /root/resources/client-truststore.jks /root/dev/wso2am-4.2.0/repository/resources/security/client-truststore.jks.

mkdir /root/prod
unzip /root/wso2am-4.2.0.zip -d /root/prod/
cp /root/resources/original-deployment-2.toml /root/prod/wso2am-4.2.0/repository/conf/deployment.toml
cp /root/resources/client-truststore.jks /root/prod/wso2am-4.2.0/repository/resources/security/client-truststore.jks
