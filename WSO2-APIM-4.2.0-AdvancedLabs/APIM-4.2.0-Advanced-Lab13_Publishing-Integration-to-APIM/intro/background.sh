...
sed 's/PORT/8050/g' /etc/killercoda/host > /tmp/mihost
sed -i 's|https://||g' /tmp/mihost
...
sed -ie "s|<WSO2_MI_HOST>|$(sed 's:http:http:g' /tmp/mihost)|g" /root/resources/apim-nginx.conf
